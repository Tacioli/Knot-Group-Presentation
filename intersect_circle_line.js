function IntersectCircleLine(xC,yC,r,p1,p2,q1,q2){
    ...
    let G  = p1 * p1 - 2 * p1 * q1 + p2 * p2 - 2 * p2 * q2 + q1 * q1 + q2 * q2;
    let K  =  -p1 * p1 * q2 * q2 + 2 * p1 * p1 * q2 * yC + p1 * p1 * r * r - p1 * p1 * yC * yC + 2 * p1 * p2 * q1 * q2 - 2 * p1 * p2 * q1 * yC - 2 * p1 * p2 * q2 * xC + 2 * p1 * p2 * xC * yC - 2 * p1 * q1 * q2 * yC - 2 * p1 * q1 * r * r + 2 * p1 * q1 * yC * yC + 2 * p1 * q2 * q2 * xC - 2 * p1 * q2 * xC * yC - p2 * p2 * q1 * q1 + 2 * p2 * p2 * q1 * xC + p2 * p2 * r * r - p2 * p2 * xC * xC + 2 * p2 * q1 * q1 * yC - 2 * p2 * q1 * q2 * xC - 2 * p2 * q1 * xC * yC - 2 * p2 * q2 * r * r + 2 * p2 * q2 * xC * xC + q1 * q1 * r * r - q1 * q1 * yC * yC + 2 * q1 * q2 * xC * yC + q2 * q2 * r * r - q2 * q2 * xC * xC;
    let L  = p1 * p1 - p1 * q1 - p1 * xC + p2 * p2 - p2 * q2 - p2 * yC + q1 * xC + q2 * yC;
    let s  = [(Math.sqrt(K)+L)/G, -(Math.sqrt(K)-L)/G];
    return s;
}
